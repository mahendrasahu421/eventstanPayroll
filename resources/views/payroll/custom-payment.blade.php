                ...
                <form method="POST" action="{{ route('payroll.custom-payment.store') }}" id="customPaymentForm">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Payment Scope <span
                                            class="text-danger">*</span></label>
                                    <div class="d-flex flex-column gap-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="payment_scope"
                                                id="scopeMonth" value="month" @checked(old('payment_scope', 'month') === 'month')>
                                            <label class="form-check-label" for="scopeMonth">Month-wise salary</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="payment_scope"
                                                id="scopeRange" value="range" @checked(old('payment_scope') === 'range')>
                                ...
                                <div class="col-md-6" id="monthScopeBox">
                                    ...
                                    <input type="month" name="month"
                                        ...
                                        value="{{ old('month', $month ?? now()->format('Y-m')) }}">
                                    @error('month')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-transparent border-0 pt-3">
                            <h5 class="mb-0 fw-bold"><i class="bi bi-cash-stack me-2 text-info"></i>Adjustment Controls
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="present_days" class="form-control" min="0"
                                        step="1" value="{{ old('present_days') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Leave Days</label>
                                    <input type="number" name="leave_days" class="form-control" min="0"
                                        step="1" value="{{ old('leave_days') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Overtime Hours</label>
                                    <input type="number" name="overtime_hours" class="form-control" min="0"
                                        step="0.5" value="{{ old('overtime_hours') }}">
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">Food Deduction</label>
                                    <input type="number" name="food_deduction" class="form-control" min="0"
                                        step="0.01" value="{{ old('food_deduction') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Visa Deduction</label>
                                    <input type="number" name="visa_deduction" class="form-control" min="0"
                                        step="0.01" value="{{ old('visa_deduction') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Insurance Deduction</label>
                                    <input type="number" name="insurance_deduction" class="form-control" min="0"
                                        step="0.01" value="{{ old('insurance_deduction') }}">
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">Advance Adjustment</label>
                                    <input type="number" name="advance_deduction" class="form-control" min="0"
                                        step="0.01" value="{{ old('advance_deduction') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Other Deduction</label>
                                    <input type="number" name="other_deduction" class="form-control" min="0"
                                        step="0.01" value="{{ old('other_deduction') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">WPS First Transfer</label>
                                    <input type="number" name="wps_first_transfer" class="form-control" min="0"
                                        step="0.01" value="{{ old('wps_first_transfer') }}">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Partial Amount</label>
                                    <input type="number" name="partial_amount" class="form-control" min="0"
                                        step="0.01" value="{{ old('partial_amount') }}">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="remarks" rows="4" class="form-control"
                                        placeholder="Optional notes, approvals, or hold/release comments">{{ old('remarks') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
