                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-0">
                            <div class="list-group list-group-flush">
                                ...
                                <a href="{{ route('employees.show', $doc->employee_id) }}" class="list-group-item list-group-item-action">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="fw-semibold">{{ $doc->employee->full_name }}</div>
                                            <small class="text-muted">{{ ucwords(str_replace('_', ' ', $doc->document_type)) }}</small>
                                        </div>
                                ...
                                <div class="text-center p-3">
                                    <a href="{{ route('employee-documents') }}" class="btn btn-sm btn-outline-primary">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-semibold">{{ \Carbon\Carbon::parse($record->payroll_month)->format('M Y') }}</div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('payroll.slip', $record) }}" class="btn btn-sm btn-outline-primary" title="View Slip">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center py-4">
                                            ...
                                            <a href="{{ route('payroll.process') }}" class="btn btn-sm btn-primary mt-2">
                                                Process Payroll
                                            </a>
                                        </td>
                                    </tr>
