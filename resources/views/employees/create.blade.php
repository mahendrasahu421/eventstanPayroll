        ...
        <form method="POST" action="{{ route('employees.store') }}" enctype="multipart/form-data" id="employeeForm">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-transparent border-0 pt-3">
                            <h5 class="mb-0 fw-bold"><i class="bi bi-shield-check me-2 text-primary"></i>Insurance Details
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="custom_fields[insurance_provider]" class="form-control"
                                        value="{{ old('custom_fields.insurance_provider') }}"
                                        placeholder="e.g., DAMAN, AXA">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Policy Number</label>
                                    <input type="text" name="custom_fields[insurance_policy_number]"
                                        class="form-control" value="{{ old('custom_fields.insurance_policy_number') }}"
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    <hr class="my-2">
                                    <h6 class="fw-bold mb-3"><i class="bi bi-piggy-bank me-2"></i>Fixed Monthly Deductions
                                    </h6>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="visa_total_installments" step="1"
                                            class="form-control" value="{{ old('visa_total_installments', 1) }}"
                                            min="1" max="120">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-light">AED</span>
                                        <input type="number" name="insurance_deduction" step="0.01"
            ...
            async function loadDesignations(departmentId, designationId = null) {
                ...
                try {
                    ...
                    data.designations.forEach(d => {
                        const selected = (designationId && Number(d.id) === Number(designationId)) ?
                            'selected' : '';
