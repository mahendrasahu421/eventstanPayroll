...
// Personal fields
            ...
            'documents.passport.issue_date' => 'nullable|date',
            ...
            'documents.emirates_id.issue_date' => 'nullable|date',
            ...
            'documents.insurance' => 'nullable|array',
            'documents.insurance.number' => 'nullable|string|max:50',
            'documents.insurance.issue_date' => 'nullable|date',
            'documents.insurance.expiry_date' => 'nullable|date',
            'documents.insurance.file' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:5120',
            'documents.driving_license' => 'nullable|array',
            'documents.driving_license.number' => 'nullable|string|max:50',
            'documents.driving_license.issue_date' => 'nullable|date',
            ...
            // Insurance metadata (saved as real columns in employees)
            'custom_fields.insurance_provider' => 'nullable|string|max:255',
            'custom_fields.insurance_policy_number' => 'nullable|string|max:255',
            'custom_fields.insurance_card_number' => 'nullable|string|max:255',
            'custom_fields.insurance_start_date' => 'nullable|date',
            'custom_fields.insurance_end_date' => 'nullable|date',
